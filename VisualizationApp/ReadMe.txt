========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto VisualizationApp
========================================================================

La creazione guidata applicazione ha creato questa applicazione VisualizationApp.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione VisualizationApp.


VisualizationApp.vcxproj
...
VisualizationApp.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato VisualizationApp.pch e il file dei tipi precompilato StdAfx.obj.
